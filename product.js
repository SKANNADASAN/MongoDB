//Question: To Insert many products:
//Ans:
...
//Ans:
db.products.find({product_price:{$gte:500}}).sort({product_price:1}).limit(5)
//Question 5: Find the product name and product material of each products
//Ans:
db.products.find().forEach(function(prod){print(prod.product_name,prod.product_material)})
